...
require (
	...
	k8s.io/apiserver v0.0.0-20190827050453-af7043d7e94e
	k8s.io/client-go v0.0.0-20190827050453-cfbd47c887ff
	k8s.io/code-generator v0.0.0-20190827050453-661ed15f12a9
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20190827050453-af7043d7e94e
