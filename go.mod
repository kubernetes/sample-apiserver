...
require (
	...
	k8s.io/api v0.0.0-20200414061335-2433a9db3db3 // indirect
	k8s.io/apimachinery v0.0.0-20200413181316-06deae5c9c2c
	k8s.io/apiserver v0.0.0-20200413222431-6560375dd2db
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20200413222431-6560375dd2db
