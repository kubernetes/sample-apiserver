...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Whitelist2)(nil), (*wardle.Whitelist2)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Whitelist2_To_wardle_Whitelist2(a.(*Whitelist2), b.(*wardle.Whitelist2), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*wardle.Whitelist2)(nil), (*Whitelist2)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_wardle_Whitelist2_To_v1alpha1_Whitelist2(a.(*wardle.Whitelist2), b.(*Whitelist2), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*Whitelist2List)(nil), (*wardle.Whitelist2List)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Whitelist2List_To_wardle_Whitelist2List(a.(*Whitelist2List), b.(*wardle.Whitelist2List), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*wardle.Whitelist2List)(nil), (*Whitelist2List)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_wardle_Whitelist2List_To_v1alpha1_Whitelist2List(a.(*wardle.Whitelist2List), b.(*Whitelist2List), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Whitelist2_To_wardle_Whitelist2(in *Whitelist2, out *wardle.Whitelist2, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.ID = in.ID
...
// Convert_v1alpha1_Whitelist2_To_wardle_Whitelist2 is an autogenerated conversion function.
func Convert_v1alpha1_Whitelist2_To_wardle_Whitelist2(in *Whitelist2, out *wardle.Whitelist2, s conversion.Scope) error {
	return autoConvert_v1alpha1_Whitelist2_To_wardle_Whitelist2(in, out, s)
}

func autoConvert_wardle_Whitelist2_To_v1alpha1_Whitelist2(in *wardle.Whitelist2, out *Whitelist2, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.ID = in.ID
	out.Ips = *(*[]string)(unsafe.Pointer(&in.Ips))
	out.Name = in.Name
...
// Convert_wardle_Whitelist2_To_v1alpha1_Whitelist2 is an autogenerated conversion function.
func Convert_wardle_Whitelist2_To_v1alpha1_Whitelist2(in *wardle.Whitelist2, out *Whitelist2, s conversion.Scope) error {
	return autoConvert_wardle_Whitelist2_To_v1alpha1_Whitelist2(in, out, s)
}

func autoConvert_v1alpha1_Whitelist2List_To_wardle_Whitelist2List(in *Whitelist2List, out *wardle.Whitelist2List, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]wardle.Whitelist2)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_Whitelist2List_To_wardle_Whitelist2List is an autogenerated conversion function.
func Convert_v1alpha1_Whitelist2List_To_wardle_Whitelist2List(in *Whitelist2List, out *wardle.Whitelist2List, s conversion.Scope) error {
	return autoConvert_v1alpha1_Whitelist2List_To_wardle_Whitelist2List(in, out, s)
}

func autoConvert_wardle_Whitelist2List_To_v1alpha1_Whitelist2List(in *wardle.Whitelist2List, out *Whitelist2List, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]Whitelist2)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_wardle_Whitelist2List_To_v1alpha1_Whitelist2List is an autogenerated conversion function.
func Convert_wardle_Whitelist2List_To_v1alpha1_Whitelist2List(in *wardle.Whitelist2List, out *Whitelist2List, s conversion.Scope) error {
	return autoConvert_wardle_Whitelist2List_To_v1alpha1_Whitelist2List(in, out, s)
}
